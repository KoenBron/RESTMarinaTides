...
from base.serializers import AddBoatToEmployeeSerializer, BoatSerializer, CustomerSerializer, RemoveEmployeesFromBoatSerializer, LinkBoatToCustomerSerializer, RemoveLinkBoatToCustomerSerializer
from base.models import Boat, Customer
